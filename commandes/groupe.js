...
const {generatepp} = require('../lib/mesfonctions')
...
malvins({ nomCom: "tagall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "link", categorie: 'Group', reaction: "🙋" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "promote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "demote", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("For groups only"); }
...
/** ***fin démettre****  **/
/** **retirer** */
malvins({ nomCom: "remove", categorie: 'Group', reaction: "👨🏿‍💼" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "del", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 malvins({ nomCom: "antilink", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 malvins({ nomCom: "antibot", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "group", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "left", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "gname", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "gdesc", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
malvins({ nomCom: "gpp", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
/////////////
malvins({nomCom:"hidetag",categorie:'Group',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
...
malvins({ nomCom: "apk", reaction: "✨", categorie: "Research" }, async (dest, zk, commandeOptions) => {
